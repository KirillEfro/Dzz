    ...
    with psycopg2.connect(database="1", user="postgres",
        ...
        with conn.cursor() as curs:
            ...
            print("Добавлен клиент id: ",
                  insert_client(curs, "Кирилл", "Ефремов", "565ddu@gmail.com"))
            print("Добавлен клиент id: ",
                  insert_client(curs, "Алексей", "Столяров",
                                "787ded@mail.ru", 79993895644))
            print("Добавлен клиент id: ",
                  insert_client(curs, "Дмитрий", "Гордей",
                                "87ffr@outlook.com", 79933319764))
            print("Добавлен клиент id: ",
                  insert_client(curs, "Иван", "Булкин",
                                "sanya@mail.ru", 79913312643))
            print("Добавлена клиент id: ",
                  insert_client(curs, "Евгений", "Дубровский",
                                "cars23@outlook.com"))
            ...
            print("Изменены данные клиента id: ",
                  update_client(curs, 4, "Александр", None, '123@outlook.com'))
            ...
            pprint(find_client(curs, 'Дмитрий'))

            print('Найденный клиент по email:')
            pprint(find_client(curs, None, None, 'cars23@outlook.com'))

            print('Найденный клиент по имени, фамилии и email:')
            pprint(find_client(curs, 'Дмитрий', 'Гордей',
                               '87ffr@outlook.com'))

            print('Найденный клиент по имени, фамилии, телефону и email:')
            pprint(find_client(curs, 'Александр', 'Булкин',
